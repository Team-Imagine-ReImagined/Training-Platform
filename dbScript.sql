...
insert into course (courseName, courseDate, location, description, courseTrainer, info, maxAttendees)
values ('EAYL Induction', date'2019-12-14', 'Park Inn', 'Getting new EAYLs up to speed with company processes and basic programing languages.', 'Shaun Ganley', 'Suitable for those who have recently joined Kainos as EAYL', 10);
insert into course (courseName, courseDate, location, description, courseTrainer, info, maxAttendees)
values ('Trainee Development Programme', date'2019-11-03', 'Mount Charles', 'Getting placements and graduates up to speed with company processes and basic programing languages.', 'Roisin Goodman', 'Suitable for those who have recently joined Kainos as a graduate or placement student.', 15);
insert into course (courseName, courseDate, location, description, courseTrainer, info, maxAttendees)
values ('New Manager Crash Course', date'2020-03-23', 'Ascot', 'Teaching hopeful managers how to rule over their subordinates', 'Brendan Mooney', 'Suitable for those who want to earn more of that sweet dolla.', 20);
insert into course (courseName, courseDate, location, description, courseTrainer, info, maxAttendees)
values ('Taking It Easy', date'2020-06-27', 'Upper Crescent', 'Helping you rest and relax in the workplace', 'Ryan Connolly', 'Suitable for those who want People Support to start secretly investigating them.', 25);
